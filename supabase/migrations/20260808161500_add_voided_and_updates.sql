...
-- Update process_offline_sale RPC to include is_voided
...
BEGIN
  ...
  LOOP
    INSERT INTO sale_items (
      ...
      selling_price, line_total, line_profit, custom_name, is_discounted, is_voided
    ) VALUES (
